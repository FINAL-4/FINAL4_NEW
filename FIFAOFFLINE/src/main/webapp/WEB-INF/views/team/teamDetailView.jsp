...
<br><br><br><div id = "title"> 
   ...
   <div class="ha-waypoint" data-animate-down="ha-header-show" data-animate-up="ha-header-subshow" style="height: 900px; width: 90%; border: black; margin: auto;">
      ...
      <table align = center id = pictureContent>
         ...
         <tr>
            <td colspan=2 style="width:100%; text-align:center;">${t.teamName }</td>
         </tr>
         <tr>
            <td colspan="2">전적 : ${scoreStr}</td>
         </tr>
      </table>
      </div>
      ...
      <table id = detailContent1> 
         ...
         <tr>
            <td colspan=2> 신청을 신청하기를 눌러주세요. <br> 수락 여부를 문자로 보내드리겠습니다. </td>
         </tr>
      </table>
      </div>
      ...
      -->
         ...
         <div id = btn>
            ...
            <input type = button id = applyBtn value="신청하기" onclick='applyTeam()'> <br>
            </div> <br><br>
            <div id = btnPosition2>
      ...
      <div id = applyDetail style="float: left; display:none;"> 
         <table id = applyDetailTable>
            ...
            <tr>   
               <td>
                  <p style="font-size:20px;">신청한 인원이 없습니다.</p>
               </td>
            </tr>      
            </c:if>
            <tr>
